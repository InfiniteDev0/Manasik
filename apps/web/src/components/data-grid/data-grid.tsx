  ...
  return (
    ...
    >
      ...
      <div
        ...
        tabIndex={0}
        ref={dataGridRef}
        // Local addition (not in tablecn): the app's pill scrollbar (globals.css).
        className="scrollbar-pill relative grid select-none overflow-auto rounded-md border focus:outline-none"
        style={{
          ...columnSizeVars,
          maxHeight: `${height}px`,
        }}
